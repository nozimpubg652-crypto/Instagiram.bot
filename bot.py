...
# TOKENINGIZNI SHU YERGA YOZING (Agar Railway o'zgaruvchisi ishlamasa)
...
# INSTAGRAM VIDEO HAVOLASI UCHUN HESHTEGLAR (O'zgartirildi)
...
async def get_instagram_hashtags(msg: Message):
    ...
    try:
        ...
        await msg.answer("❌ Uzr, bu videodan matnni olib bo'lmadi. Havola ochiq ekanligiga ishonch hosil qiling.")
