...
CHANNEL_ID = "@instamuzik"  # Shu yerni o'z kanalingiz manzili bilan almashtiring
...
# --- MAJBURIY OBUNA TEKSHIRUV FUNKSIYASI ---
...
async def check_sub_callback(callback: types.CallbackQuery):
    is_sub = await check_sub(callback.from_user.id)
    if is_sub:
        await callback.message.delete()
        await callback.message.answer("Rahmat! Obuna bo'ldingiz.", reply_markup=get_main_menu())
    else:
        await callback.answer("Siz hali kanalga obuna bo'lmadingiz!", show_alert=True)

# --- QOLGAN FUNKSIYALAR (Sizning kodingiz o'zgarmadi) ---
