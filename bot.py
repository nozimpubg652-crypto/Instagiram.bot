...
# --- 2 TALIK PANEL CHIQARISH UCHUN QO'SHILGAN YANGI QISM ---
inline_buttons = []
for text, data in buttons:
    inline_buttons.append(InlineKeyboardButton(text=text, callback_data=data))

# Agar tugmalar soni toq bo'lsa, panel tekis chiqishi uchun oxiriga bitta tugma qo'shiladi
if len(inline_buttons) % 2 != 0:
    inline_buttons.append(InlineKeyboardButton(text="🔄 Yangilash", callback_data="start"))

# Hammasini bittada unpack qilib super_menu ichiga qo'shamiz
super_menu.add(*inline_buttons)
# -----------------------------------------------------------
...
async def process_all(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if data == "video":
        ...
        await callback_query.message.answer(
            ...
            "<b>Shart:</b> @temuzikinsta kanaliga 5 ta do‘stni qo‘shishingiz kerak.\n"
