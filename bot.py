...
async def process_all(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    if data == "video":
        ...
        eslatma_text = (
            "𖣔”𝖤𝗌𝗅𝖺𝗍𝗂𝗇𝗀” 𝗓𝖾𝗋𝗈 𝖾𝗌𝗅𝖺𝗍𝗆𝖺 𝗆𝗈’𝗆𝗂𝗇𝗅𝖺𝗋𝗀𝖺 𝗆𝖺𝗇𝖿𝖺𝖺𝗍 𝗒𝖾𝗍𝗄𝖺𝗓𝗎𝗋. (Zarriyot surasi, 55 ) ___\n"
            "𝖠𝗅𝗁𝖺𝗆𝖽𝗎𝗅𝗂𝗅𝗅𝖺𝗁 - 𝘉𝘢𝘳𝘤𝘩𝘢 𝘮𝘢𝘲𝘵𝘰𝘷 𝘈𝘭𝘭𝘰𝘩𝘨𝘢 ( 𝘈\\𝘭𝘭𝘰𝘩𝘨𝘢 𝘩𝘢𝘮𝘥𝘭𝘢𝘳 𝘣𝘰’𝘭𝘴𝘪𝘯)...\n"
            "𝖠𝗅𝗅𝗈𝗁 𝖠𝗄𝖻𝖺𝗋 - 𝘒𝘢𝘭𝘭𝘰𝘩 𝘣𝘶𝘺𝘶𝘬𝘥𝘪𝘳... . . . ☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎☁︎ ♻️ "
            "𝖵𝗂𝖽𝖾𝗈𝗇𝗂 𝗒𝖺𝗊𝗂𝗇 𝖻𝗂𝗋𝗈𝖽𝖺𝗋𝗅𝖺𝗋𝗀𝖺 𝗎𝗅𝖺𝗌𝗁𝗂𝗇𝗀. 𝖨𝗇𝗌𝗁𝖺 𝖺𝗅𝗅𝗈𝗁 𝖻𝗎𝗇𝗂𝗇𝗀 𝖺𝗃𝗋𝗎 𝗌𝖺𝗏𝗈𝗉𝗂 𝖻𝗈𝗋... 𖣔\n\n"
            "👥 𝖮𝖻𝗎𝗇𝖺 𝖻𝗈’𝗅𝗂𝗇𝗀❗️\n.\n.\n.\n.\n"
            "#мухаммад #shermuhammedoff #аллахвелик #nuridddinhojidomla #shayxmuhammadsoqidmuhammadyusuf "
            "#namaz #inshaallah #shukurullohdomla #abrormuxtoraliy #muslim #аллахуакбар #islam #мусульманин "
            "#subhanallah #аллахуакбар☪ #masyaallahtabarakallah #коран #allahﷻ #ислам #mashaallah #видеокоран "
            "#allah #shermuhammedoff #desiganxious #намаз🍃 #коранисунна #мухаммадﷺ #мухаммад #allahuakbar "
            "#машаллах #пророк #denov_ako #tushuncha_ol\n\n"
            "Reaksiya bosilmaganidan 🤝🏼📌"
        )
        ...
        secrets_text = (
            ...
            "• Profilingizda <i>Settings -> Data usage and media quality -> Upload at highest quality</i> funksiyasini yoqib qo'ying. Videolar sifati buzilmaydi.\n"
            "• Videoning dastlabki 3 soniyasida 'Hook' (ilmoq) ishlating. Masalan: 'Hech kim bilmaydigan 3 ta sir...' yoki 'Buni oxirigacha ko'ring...'\n\n"
            "2️⃣ <b>Kunlarga mos vaqt va Heshteglar:</b>\n"
            "• <b>Dushanba-Chorshanba:</b> Kechki 20:00 va 22:00 (Aktiv yuqori bo'ladi).\n"
            "👉 <i>Heshteglar:</i> #explore #uzb #trend #reelsuz\n"
            "• <b>Payshanba-Juma:</b> Kun buyi aktiv. Juma kuni 13:00 va 21:00 zo'r vaqt.\n"
            "👉 <i>Heshteglar:</i> #juma #islom #eslatma #viraluz\n"
            "• <b>Shanba-Yakshanba:</b> Ertalab 11:00 va kechasi 00:00.\n"
            "👉 <i>Heshteglar:</i> #weekend #prikol #dam #top"
        )
        ...
        # Avtomatlashtirilgan yoki statik yangi kurslar
        ...
        # Boshqa tugmalar uchun standart oddiy javoblar tizimi
        responses = {
            ...
            "obhavo": "🌤 Ob-havo: Qashqadaryo – 34°C, quyoshli.",
...
async def play_rps(callback_query: types.CallbackQuery):
    ...
    # Tenglik ehtimolini kamaytirish va yutuq/yutqiziqni muvozanatlash
    rand_val = random.random()
    if rand_val < 0.1:  # 10% Lik tenglik ehtimoli
...
async def process_chek_photo(message: types.Message, state: FSMContext):
    # Chek rasmini va foydalanuvchi ma'lumotlarini admenga yo'naltirish
...
async def process_nick_generation(message: types.Message, state: FSMContext):
    ...
    # 1 milliondan ko'p kombinatsiya yaratish uchun loop
    generated_nick = None
    for _ in range(100):  # Noyob nik topilguncha urinish
        pref = random.choice(prefixes)
        suff = random.choice(suffixes)
        rand_num = random.randint(1000, 9999) # 4 xonali raqam entropiyani keskin oshiradi
        
        # Turli xil nik formatlari konstruktsiyasi
